  ...
  return (
    <Paper sx={{ px: 10, py: 10, minHeight: '60vh' }} elevation={0}>
      {isLoading ? (
        ...
        <>
          <TitleManager variant='h6' icon='heroicons:user-20-solid' textTransform={'uppercase'}>
            Chi tiết giảng viên hướng dẫn
          </TitleManager>
          <Box mt={10} display={'flex'} gap={8}>
            ...
            <Box>
              ...
              <Typography fontWeight={500} color='error.main' mt={3} variant='h5'>
                Chuyên ngành: {data.lecturerTerm.majorName}
              </Typography>
              <Box mt={10} display={'flex'} justifyContent={'space-evenly'} gap={10}>
                <Box fontWeight={500} display={'flex'} gap={4}>
                  ...
                  <Typography variant='h6' fontWeight={500} color='grey.600'>
                    {data.lecturerTerm.phone ? data.lecturerTerm.phone : 'Chưa có thông tin'}
                  </Typography>
                </Box>
                <Box fontWeight={500} display={'flex'} gap={4}>
                  <Icon width={24} icon='material-symbols:mail-outline' />
                  <Typography variant='h6' fontWeight={500} color='grey.600'>
                    {data.lecturerTerm.email ? data.lecturerTerm.email : 'Chưa có thông tin'}
                  </Typography>
                </Box>
                <Box fontWeight={500} display={'flex'} gap={4}>
