...
function Task(props: any) {
  ...
  let dataLecturerGradingInstructions = task.filter(
        ...
        <Box flex={1}>
          <Box justifyContent={'space-between'} display={'flex'} mb={10}>
            <Typography variant='h4' fontWeight={'bold'} color='error.main'>
              Tao Nhóm giảng viên chấm hướng dẫn
            </Typography>
            <Box>
          ...
          >
            <Box className='drag_container'>
              <Box className='container'>
                <Box className='drag_column'>
                  <Box className='drag_row'>
                    {dataLecturerGradingInstructions.map((task: any) => (
                      <Tooltip title={<Typography variant='body2'>Kéo thả thẻ này</Typography>}>
                        <Box
                          sx={{
                            bgcolor: 'grey.100',
          ...
          >
            <Typography flex={1} variant='h6' color='primary.main' fontWeight={'500'}>
              Số lượng : {'      '}
              <span style={{ color: 'black' }}> {dataLecturerGradingInstructions.length} / 3</span>
            </Typography>
